...
[^labels]: For the ease of interpretation in this analysis, I have given each
...
<!--
Based on the factor model structure and these correlations we can define names
for each of these factors:

* Factor 1: *management* &ndash; this factor
-->
...
respectively), and then *'pay and benefits'* and '*career*' themes (0.157 and
...
drivers_coefs |>
    dplyr::mutate(
        term = dplyr::case_match(
            ...
            "f5_pay" ~ "Factor 5: Pay and benefits",
            "f6_objectives" ~ "Factor 6: Objectives",
            "f7_learning" ~ "Factor 7: Learning",
